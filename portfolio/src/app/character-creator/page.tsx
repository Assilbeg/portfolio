...
const QUESTIONS = [
  ...
  },
  {
    ...
    hasImages: true,
    options: [
      { value: 'bald', label: 'Chauve', image: '/images/hair-bald.jpg' },
      { value: 'buzz', label: 'Coupe Buzz', image: '/images/hair-buzz.jpg' },
      { value: 'short', label: 'Court', image: '/images/hair-short.jpg' },
      { value: 'medium', label: 'Longueur moyenne', image: '/images/hair-medium.jpg' },
      { value: 'long', label: 'Longues', image: '/images/hair-long.jpg' }
    ]
  },
  {
    id: 'hairStyle',
    ...
    hasImages: true,
    options: [
      { value: 'straight', label: 'Droit', image: '/images/hair-straight.jpg' },
      { value: 'wavy', label: 'Ondulé', image: '/images/hair-wavy.jpg' },
      { value: 'curly', label: "Boucles d'oreilles", image: '/images/hair-curly.jpg' },
      { value: 'dreadlocks', label: 'Dreadlocks', image: '/images/hair-dreadlocks.jpg' }
    ]
  }
];
...
export default function CharacterCreator() {
  ...
  const handleContinue = () => {
    if (currentStep < QUESTIONS.length - 1) {
      ...
      // Ici on pourrait rediriger vers la page de génération d'images
    }
  };
    ...
    return (
      ...
      >
        ...
        <_Builtin.Block style={{ flex: 1 }}>
          ...
          {/* Image for hair length/style options */}
          {currentQuestion.hasImages && option.image && (
            <_Builtin.Block
              style={{
                width: '60px',
                height: '60px',
